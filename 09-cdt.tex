...
\item $A$ and $B$ are \textbf{probabilistically independent} relative
  ...
  \ref{sec:conditional}.)  
\item $A$ and $B$ are \textbf{causally independent} if it is certain
  that whether or not one of them is true has no causal influence
  over whether the other is true.
\end{itemize}

\begin{exercise}
  I the student's decision problem, is it reasonable to assume that
  the states are logically independent of the acts? Is it reasonable
  to assume that they are causally independent? Is it reasonable to
  treat them as probabilistically independent? $\star$
\end{exercise}
...
then, by definition,
\[
EU(A) = U(O_1) \times \Cr(S_1) + \ldots + U(O_n) \times \Cr(S_n).
\]
...
\cmnt{%
  ...
  studying has expected utility $1 \times 0.2 + 1 \times 0.7 + (-8) \times
  0.1 = 0.1$, while not studying has expected utility $5 \times 0.2 + (-2)
  \times 0.7 + (-2) \times 0.1 = -0.6$. So studying maximizes expected utility.
} %
...
the expected utility of studying is $1 \times 0.9 + (-8) \times 0.1 =
0.1$; for not studying we get $5 \times 0.2 + (-2) \times 0.8 = -0.6$.
...
\[
EU(A) = U(O_1) \times \Cr(S_1/A) + \ldots + U(O_n) \times \Cr(S_n/A).
\]
...
\cmnt{%
  ...
  \begin{genericthm}{Conditional expected utility}
    ...
    \[
    CEU(A) = \Cr(S_1/A) \times U(O_1) + \ldots + \Cr(S_n/A) \times U(O_n).
    \]
  \end{genericthm}
...
is certain to result from the act in that state). This feature is a
weak form of what is sometimes called \textbf{partition invariance}.
...
figure out all the outcomes $O_1,\ldots, O_n$ that the act might bring
...
%
\[
EU(A) = U(O_1) \times \Cr(O_1/A) + \ldots + U(O_n) \times \Cr(O_n/A).
\]
%
\begin{exercise}
...
\[
U(A) = U(A\land O_1) \times \Cr(A \land O_1/A) + \ldots +
       U(A\land O_n) \times \Cr(A \land O_n/A).
\]
Since $\Cr(A \land O_i/A) = \Cr(O_i/A)$, this simplifies to
\[
U(A) = U(A\land O_1) \times \Cr(O_1/A) + \ldots +
       U(A\land O_n) \times \Cr(O_n/A).
\]
...
\[
U(A) = U(O_1) \times \Cr(O_1/A) + \ldots + U(O_n) \times \Cr(O_n/A).
\]
...
\begin{exercise}
  ...
  \[
  U(PF \lor FF) = U(PF)\times \Cr(PF/PF \lor FF) + U(FF)\times \Cr(FF/PF\lor FF).
  \]
...
\begin{align*}
  EU(\text{1B}) &= U(\text{£1,000,000})\times
  \Cr(\text{£1,000,000}/\text{1B}) + U(\text{£0})\times
  \Cr(\text{£0}/\text{1B})\\
  &= 1,000,000 \times 0.95 + 0 \times 0.05 = 950,000.\\
  EU(\text{2B}) &= U(\text{£1,001,000})\times
  \Cr(\text{£1,001,000}/\text{2B}) + U(\text{£1000})\times
  \Cr(\text{£1000}/\text{2B})\\
  &= 1,001,000 \times 0.05 + 1000 \times 0.95 = 51,000.
\end{align*}
...
main argument for two-boxing is also simple: if you take both boxes,
you are guaranteed to get £1000 more than whatever you'd get if you
took just the blue box. Remember that the content of the boxes is
settled. The blue box either contains a thousand or a million.  And
since one-boxing and two-boxing will both give you the blue box, it is
settled that you will get however much is in that box. The only thing
that isn't settled -- the only thing over which you have any control
-- is whether you also get the £1000 from the transparent box. And if
you prefer more money to less money, then clearly (so the argument)
you should take the additional £1000.
...
place. In chapter \ref{ch:overview}, we distinguished between what an
...
\begin{exercise}
  ...
  the blue box. You'd be willing to pay the demon £500 for not
  revealing to you the content of the box. $\star\star$
\end{exercise}
...
evidential expected utility of smoking is $-9 \times 0.8 + 1 \times 0.2
= -7$, while the evidential expected utility of not smoking is $-10
\times 0.2 + 0 \times 0.2 = -2$.  According to EDT, then, you should
...
\begin{exercise}
  ...
  utility? (Explain briefly, without computing anything.) $\star$
\end{exercise}
...
\cmnt{%
  ...
  \[
  EU^s(A) = \Cr(S_1/\!/A) \times U(O_1) + \ldots + \Cr(S_n/\!/A) \times U(O_n).
  \]
...
\begin{gather*}
  EU(1B) = 1,000,000 \times x + 0 \times (1-x);\\
  EU(2B) = 1,001,000 \times x + 1000 \times (1-x).
\end{gather*}
