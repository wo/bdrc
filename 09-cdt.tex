...
\ref{sec:structure-of-utility}, one can show that an act's evidential expected
...
\[
  \EU_\text{e}(A) = \U(O_{1})\Cr(S_{1}) + \ldots + \U(O_{n})\Cr(S_{n}).
\]
...
transparent box containing a thousand. They were, in effect, given a choice
...
$-10 \cdot 0.2 + 0 \cdot 0.8 = -2$. According to EDT, you should stop smoking.
...
indicative supposition that $A$. Let `$\Cr(B/\!/A)$' (with two slashes) denote an
...
subjunctively, that you take the box. We ask: how much would you get if you were
to take the box?
...
\cmnt{%
  ...
  \begin{example}
    ...
    before dinner, you don't know if she followed your advice, and you
  ...
  friend is alive. So if she ignored your advice and ate the mushroom,
  ...
  as that it was a death cap. Your credence in the proposition
