...
\cmnt{%
\begin{align*}
  \Cr_\text{new}(\emph{Heads}) &= \frac{\Cr_\text{old}(\emph{Red}/\emph{Heads})\cdot \Cr_\text{old}(\emph{Heads})}{\Cr_\text{old}(\emph{Red}/\emph{Heads})\cdot \Cr_\text{old}(\emph{Heads}) + \Cr_\text{old}(\emph{Red}/\emph{Tails})\cdot \Cr_\text{old}(\emph{Tails})}\\
...
\nicefrac{2}{3}. Finding that your hair is red then reduces it back to
\nicefrac{1}{2}.
