...
$A$, than to evaluate $\Cro(A/E)$, the probability of the hypothesis conditional
on the evidence.
...
\begin{example}(The Monty Hall problem)[label=ex-montyhall]
  ...
  prize. After you've made your choice of a door and the host has
...
par. We should still be cautious about endorsing the requirement, for it is likely
...
\begin{exercise}{1}
  Show that if a theory $H$ entails $E$, and $E$'s prior probability is not
...
\begin{sources}
  ...
  Popper's falsificationist approach was first spelled out in his \emph{The
    Logic of Scientific Discovery} (1935). Modern Bayesian Confirmation Theory begins with
