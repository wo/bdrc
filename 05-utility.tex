...
consequence, the two conceptions of utility -- utility as a measure of moral
good, and utility as what rational agents attempt to increase -- were not
properly distinguished. Today, both kinds of hedonism have long fallen out of
...
In these notes, `utility' is only used in the second sense. The utility of an
...
Psychological hedonists hold that humans would never deliberately do such things:
...
\begin{example}(The endowment effect)
  ...
  mug, and arbitrarily chooses the red one. A little later, someone
...
cup has greater utility than the blue cup, Emily shouldn't have been
indifferent when she decided which cup to buy. If the two cups have equal
utility for Emily, Emily should be happy to swap the red cup for the blue
cup.
...
utility to \emph{drinking tea and drinking either tea or coffee}.
...
logically necessary propositions have maximal utility. As much as you desire
...
utilities and you desire Alder Park and Buckeye Park to equal degree $x$,
...
\begin{exercise}{2}
  ...
  \begin{exlist}
    \item Whenever an agent desires $A\land B$, they also desire $A$.
...
utility.
% I should clarify this. We also assume that equivalent propositions have
% equal utility, and -- more importantly -- that strength of desire is
% representable by real numbers, which implies that comparative desirability is
% an archimedian weak order.
...
Now change the scenario so that you have two basic desires: being free from
...
different label, if only because some of an agent's concerns may never figure as
...
your intrinsic utility function might be fully given as follows:
\begin{gather*}
...
\begin{exercise}{1}
  Suppose your only basic desire is that a certain person in India is happy.
...
\begin{example}
  ...
  her advice, and you never asked about it. But you've seen your friend several
...
ignored your advice and ate the mushroom, then the mushroom was almost certainly
...
proposition $A$ were the case generally arises from uncertainty about ordinary
